...
typedef enum _moldError {
    ...
    MOLD_ERROR_FLASH_CHECK_CORRECT_FREE_BLOCK_ADDR_NEXT_FREE_BLOCK_NOT_FREE    = 0x1a,
    MOLD_ERROR_FLASH_CHECK_CORRECT_FREE_BLOCK_ADDR_BEFORE_NEXT_FREE_BLOCK_FREE = 0x1b,
