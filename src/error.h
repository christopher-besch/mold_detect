...
typedef enum _moldError {
    ...
    MOLD_ERROR_INVALID_PARAMS_FLASH_SECTOR_ERASE_ERASE_FAILED                = 0x08,
    MOLD_ERROR_INVALID_PARAMS_FLASH_SECTOR_ERASE_NOT_AT_START_OF_SECTOR      = 0x09,
    MOLD_ERROR_FLASH_SECTOR_ERASE_ERASE_FAILED                               = 0x0a,
